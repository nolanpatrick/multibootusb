...
grub_target_cppflags=' -Wall -W  -DGRUB_MACHINE_PCBIOS=1 -DGRUB_MACHINE=I386_PC -m32 -nostdinc -isystem /usr/lib/gcc/x86_64-redhat-linux/6.1.1/include -I$(top_srcdir)/include -I$(top_builddir)/include'
grub_target_ccasflags=' -g  -m32 -msoft-float'
grub_target_ldflags='-static -m32 -Wl,-melf_i386 -Wl,--build-id=none'
grub_cflags=' -fno-strict-aliasing  -g -pipe -Wall -Werror=format-security     -grecord-gcc-switches  -mtune=generic'
grub_cppflags=' -D_FILE_OFFSET_BITS=64'
grub_ccasflags=' -fno-strict-aliasing  -g -pipe -Wall -Werror=format-security     -grecord-gcc-switches  -mtune=generic'
